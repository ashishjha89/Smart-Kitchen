...
class RecipeRepo {
    ...
    private val paneerButterMasala = RecipeModel(name = "Paneer Masala", imageId = R.drawable.paneer_butter_masala)
    ...
    private val roastedSalmonSmokyChickpeasGreens = RecipeModel(name = "Roasted Salmon Smoky Chickpeas Greens", imageId = R.drawable.roasted_salmon_smoky_chickpeas_greens)
    ...
    val recommendationList = arrayListOf(bakedEggModel, sauteedChickenBreastsCreamySauce, sakePoachedChickenWithSobaNoodles, chickenBiryani, lemonDillChicken, paneerButterMasala, saagPaneerRecipe)
    val trendingList = arrayListOf(fiestaChickenRecipe, japaneseFriedRice, kasenYakiSoba, roastedPumpkinAppleSoup, healthyBeenSalad, paneerButterMasala, sauteedChickenBreastsCreamySauce)
    val healthyList = arrayListOf(healthyBeenSalad, misoSoup, saagPaneerRecipe, bakedEggModel, zucchiniNoodlesAvocadoPeso, sauteedChickenBreastsCreamySauce, lemonDillChicken)
    val favoritesList = arrayListOf(roastedSalmonSmokyChickpeasGreens, sauteedChickenBreastsCreamySauce, bakedEggModel, saagPaneerRecipe, fiestaChickenRecipe, sakePoachedChickenWithSobaNoodles)
    val familyList = arrayListOf(zucchiniNoodlesAvocadoPeso, butterBeanSpinach, indianCauliflowerRecipe, paneerButterMasala, quickMongolianBeef, roastedPumpkinAppleSoup, healthyBeenSalad)
    val specialList = arrayListOf(quickMongolianBeef, roastedPumpkinAppleSoup, poachedChickenWithBrothVermicelliNoodles, chickenBiryani, saagPaneerRecipe, misoSoup, indianCauliflowerRecipe)
}